...
sap.ui.define([
	...
	"com/ness/employeed/model/formatter",
	"sap/ui/Device"
], function(BaseController, JSONModel, formatter, Device) {
	"use strict";
	return BaseController.extend("com.ness.employeed.controller.Detail", {
		formatter: formatter,
		/* =========================================================== */
		/* lifecycle methods                                           */
		/* =========================================================== */
		...
		onRoleItemPressed: function(oEvent) {
		...
		/**
		 *@memberOf com.ness.employeed.controller.Detail
		 */
		roleDetailsItemPressed: function(oEvent) {
			
			var path = oEvent.getSource().getBindingContextPath();
			var oItem = this.getModel().getProperty(path);
			
			//Thode was generated by the layout editor.
			this.getRouter().navTo("roleDetails",{
				objectId: oItem.employeeId,
				RoleId:  oItem.roleId
			}, !Device.system.phone);
		}
	});
