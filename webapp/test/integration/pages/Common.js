sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/ness/employeed/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.ness.employeed.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/ness/employeed/localService/mockserver"], function (mockserver) {
